...
- **Content-based file classification** — files are identified by *content* (claim language, declaration boilerplate, XFA element names, FIG. references), not by filename. `Application.pdf`, `Formals.pdf`, `AB2-5678US-A.pdf` — any naming convention works.
